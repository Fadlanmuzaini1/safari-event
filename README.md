...
- **Setelah giliran habis, anggota Grup 1 harus otomatis diteleport KEMBALI ke lokasi asal
  mereka** (sebelum di-teleport masuk tadi), lalu broadcast leaderboard sementara muncul.
...
- `/safari stop` untuk tes jalur giliran dihentikan paksa (teleport keluar tetap harus
  terjadi). `/safari reset` untuk tes mengakhiri seluruh sesi (broadcast hasil akhir top-3 +
  bersihkan semua pendaftaran/grup).
...
Lihat [CHANGELOG.md](CHANGELOG.md) untuk riwayat rilis (saat ini 6 rilis resmi: v0.1.0 --
