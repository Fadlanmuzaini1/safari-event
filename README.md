...
Lihat [CHANGELOG.md](CHANGELOG.md) untuk riwayat rilis (saat ini 3 rilis resmi: v0.1.0 --
framework inti, v0.2.0 -- giliran grup manual per admin, v0.3.0 -- `/safari list`).
