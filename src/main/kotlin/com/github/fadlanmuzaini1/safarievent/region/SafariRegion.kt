...
class SafariRegion private constructor(
    ...
    /**
     * AABB region ini sebagai `Box` vanilla, dipakai WildPokemonCleaner untuk mencari semua
     * entity di dalam region lewat `World.getEntitiesByClass()`. +1 pada sisi maksimum karena
     * Box vanilla memakai konvensi "sisi jauh eksklusif" (blok di posisi p menempati ruang
     * [p, p+1)) -- supaya blok di koordinat maxX/maxY/maxZ tetap tercakup penuh.
     */
    fun toBox(): Box = Box(
