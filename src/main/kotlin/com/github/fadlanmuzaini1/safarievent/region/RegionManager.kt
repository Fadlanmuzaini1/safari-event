...
class RegionManager(private val configManager: ConfigManager) {
    ...
    /** Salinan read-only semua region valid yang terdaftar. Dipakai WildPokemonCleaner untuk memindai SEMUA region, bukan cuma satu. */
    fun allRegions(): List<SafariRegion> = regions
}
