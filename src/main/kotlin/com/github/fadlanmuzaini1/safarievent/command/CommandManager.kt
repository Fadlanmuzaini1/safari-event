 ...
 *
 * CATATAN: /safari register, /safari unregister, /safari list, dan /safari reset TIDAK ada
 * di daftar command awal -- ditambahkan belakangan sebagai konsekuensi wajar dari fitur
 * pendaftaran, giliran grup manual per-grup, kebutuhan admin melihat siapa saja yang sudah
 * daftar, dan kebutuhan mengakhiri sesi secara eksplisit.
 */
